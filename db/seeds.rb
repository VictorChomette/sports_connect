...
FieldSport.create!(field: field1, sport: basketball)
...
Presence.create!(date: "2021-12-02 10:00:00 UTC", user: user2, field: field1)
Presence.create!(date: "2021-12-02 10:00:00 UTC", user: user4, field: field1)
Presence.create!(date: "2021-12-02 15:00:00 UTC", user: user1, field: field1)
Presence.create!(date: "2021-12-02 17:00:00 UTC", user: user5, field: field1)
Presence.create!(date: "2021-12-02 17:00:00 UTC", user: user6, field: field1)
Presence.create!(date: "2021-12-02 16:00:00 UTC", user: user7, field: field1)
Presence.create!(date: "2021-12-02 12:00:00 UTC", user: user2, field: field1)
Presence.create!(date: "2021-12-02 12:00:00 UTC", user: user3, field: field1)
Presence.create!(date: "2021-12-02 18:00:00 UTC", user: user8, field: field1)
