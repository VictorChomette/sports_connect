...
field5 = Field.create!(name: "Stade Léo Lagrange", address: "68 Bd Poniatowski, 75012 Paris", field_types: 2, status: 0, description: "Complexe sportif permettant de pratiquer une multitude de sport.")
...
field6 = Field.create!(name: "City Stade - Square Docteur Calmette", address: "72 Bd Lefebvre, 75015 Paris", field_types: 1, status: 1, description:"Situé au sein du Parc Georges Brassens, ce city-stade permet de jouer au basket et au foot. Des tables de Ping-Pong sont également disponible.")
...
field7 = Field.create!(name: "City Stade", address: "16 Pass. Dumas, 75011 Paris", field_types: 1, status: 2, description: "Situé à coté du centre sportif Philippe Auguste, ce city stade permet de jouer au basketball et au football en libre-service.")
FieldSport.create!(field: field7, sport: basketball)
FieldSport.create!(field: field7, sport: football)

field8 = Field.create!(name: "Terrain-Petanque", address: "57 Quai de Grenelle Paris, 75015", field_types: 1, status: 0, description: "Trois terrains de pétanque en libre-service, disponible le long des quais de Seine dans le 15eme arrondissement. N'oubliez pas de ramener votre materiel.")
FieldSport.create!(field: field8, sport: petanque)

field9 = Field.create!(name: "Tep Des Amandiers", address: "21 Rue des Cendriers, 75020 Paris", field_types: 1, status: 0, description: "Terrain mutltisports disponible pour le basket et le football accompagné d'une piste d'athlétisme. Centre sportif à disposition dans un rayon proche.")
...
field10 = Field.create!(name: "Terrain de sport Duperré", address: "22 rue Duperré 75009 Paris", field_types: 1, status: 1, description: "Plus beaux terrains de Basket de la ville de Paris. Situé dans le 9eme arrondissement, ce terrain reste ouvert au public et attire nombreux touristes.")
FieldSport.create!(field: field10, sport: basketball)

field11 = Field.create!(name: "Square Paturle", address: "1 rue Paturle 75014 Paris", field_types: 1, status: 0, description: "Terrain de Basket ouvert 24h/24.")
FieldSport.create!(field: field11, sport: basketball)

field12 = Field.create!(name: "Les Arènes de Lutèce", address: "49 rue Monge, 75005 Paris", field_types: 1, status: 0, description: "Entre histoire et loisir, profitez d'une belle partie de pétanque en plein coeur des Arènes de Lutèce !")
FieldSport.create!(field: field12, sport: petanque)

field13 = Field.create!(name: "Square Pierre-de-Gaulle", address: "2 Place du Président Mithouard, 75007 Paris", field_types: 1, status: 0, description: "Table de Ping-Pong en libre service dans le 7eme arrondissement de Paris.")
FieldSport.create!(field: field13, sport: pingpong)

field14 = Field.create!(name: "Playground du Champs-de-Mars", address: "2 All. Adrienne Lecouvreur, 75007 Paris", field_types: 1, status: 0, description: "Terrain extérieur situé sur le Champs-De-Mars. Terrain en bitume. Terrain libre pour la pétanque.")
